...
namespace Main.试验报表RPT {
    ...
    public class 水泵报表1中 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Main.试验报表RPT.水泵报表1(中).rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cached水泵报表1中 : Component, ICachedReport {
